    ...
    public partial class salesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[sales] WHERE (([saleID] = @Original_saleID) AND ([saleDate] = " +
                "@Original_saleDate) AND ([saleNoOfItems] = @Original_saleNoOfItems) AND ([saleVa" +
                "lue] = @Original_saleValue))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[sales] ([saleDate], [saleNoOfItems], [saleValue]) VALUES (@sal" +
                "eDate, @saleNoOfItems, @saleValue);\r\nSELECT saleID, saleDate, saleNoOfItems, sal" +
                "eValue FROM sales WHERE (saleID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[sales] SET [saleDate] = @saleDate, [saleNoOfItems] = @saleNoOfItems, [saleValue] = @saleValue WHERE (([saleID] = @Original_saleID) AND ([saleDate] = @Original_saleDate) AND ([saleNoOfItems] = @Original_saleNoOfItems) AND ([saleValue] = @Original_saleValue));
SELECT saleID, saleDate, saleNoOfItems, saleValue FROM sales WHERE (saleID = @saleID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT saleID, saleDate, saleNoOfItems, saleValue FROM dbo.sales";
        ...
        public virtual int Fill(inventorydbDataSet1.salesDataTable dataTable) {
        ...
        public virtual inventorydbDataSet1.salesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            inventorydbDataSet1.salesDataTable dataTable = new inventorydbDataSet1.salesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(inventorydbDataSet1.salesDataTable dataTable) {
